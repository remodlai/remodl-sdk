...
import remodl
from remodl.constants import REPLICATE_POLLING_DELAY_SECONDS
...
from remodl.utils import CustomStreamWrapper, ModelResponse
...
def completion(
    ...
    if "stream" in optional_params and optional_params["stream"] is True:
        ...
        for retry in range(remodl.DEFAULT_REPLICATE_POLLING_RETRIES):
            time.sleep(
                remodl.DEFAULT_REPLICATE_POLLING_DELAY_SECONDS + 2 * retry
            ...
            if (
                ...
                continue
            return remodl.ReplicateConfig().transform_response(
                model=model,
...
async def async_completion(
    ...
    async_handler = get_async_httpx_client(
        llm_provider=remodl.LlmProviders.REPLICATE,
        params={"timeout": 600.0},
    )
